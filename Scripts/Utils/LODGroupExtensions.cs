...
public static class LODGroupExtensions
{
    ...
    ///<summary>
    ///Calculates the current height percentage of the LODGroup relative to the Camera.
    ///</summary>
    ...
    ///<returns>The current height percentage of the LODGroup relative to the Camera.</returns>
    ///<exception cref = "System.ArgumentNullException">Thrown if the distance between the LODGroup and Camera is zero.</exception>
    ///<example>
    ///<code>float heightPercentage = lodGroup.CalculateCurrentHeightPercentage(mainCamera);</code>
    ///</example>
    public static float CalculateCurrentHeightPercentage(this LODGroup lodGroup, Camera cam)
    {
